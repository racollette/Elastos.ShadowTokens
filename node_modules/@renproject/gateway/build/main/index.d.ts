...
export default class GatewayJS {
    ...
    readonly open: (params: LockAndMintParams | BurnAndReleaseParams | LockAndMintParamsSimple | BurnAndReleaseParamsSimple | SendParams | LockAndMintEvent | BurnAndReleaseEvent, uniqueID?: string | undefined) => Gateway;
    readonly send: (params: SendParams, uniqueID?: string | undefined) => Gateway;
    readonly recoverTransfer: (web3Provider: Web3Provider, params: LockAndMintEvent | BurnAndReleaseEvent, uniqueID?: string | undefined) => Gateway;
    readonly getTokenAddress: (web3: Web3, token: RenTokens | RenContract | Asset | ("BTC" | "ZEC" | "BCH")) => Promise<string>;
    readonly getGatewayAddress: (web3: Web3, token: RenTokens | RenContract | Asset | ("BTC" | "ZEC" | "BCH")) => Promise<any>;
}
