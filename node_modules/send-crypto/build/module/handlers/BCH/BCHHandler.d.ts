...
export declare const _apiFallbacks: {
    fetchConfirmations: (testnet: boolean, txHash: string) => ((() => Promise<number>) | undefined)[];
...
export declare const getUTXOs: (testnet: boolean, options: {
    address: string;
    confirmations?: number;
}) => Promise<readonly UTXO[]>;
export declare const getConfirmations: (testnet: boolean, txHash: string) => Promise<number>;
export declare const getUTXO: (testnet: boolean, txHash: string, vOut: number) => Promise<UTXO>;
export {};
