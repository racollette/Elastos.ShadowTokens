...
export const PREAUTHORIZE_AMOUNT = 1000000 // Ether

export const ELA_CONFIRMATIONS = 1 // Blocks
export const ELA_AMB_NATIVE_ERC_MIN_TX = 100000000000000000000 // Wei
export const ELA_AMB_NATIVE_ERC_MAX_TX = 1500000000000000000000000 // Wei

export const ETH_CONFIRMATIONS = 8 // Blocks
export const ETH_AMB_NATIVE_ERC_MIN_TX = 500000000000000000 // Wei
